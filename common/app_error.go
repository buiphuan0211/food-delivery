...
type AppError struct {
	StatusCode int    `json:"status_cod"`
	RootErr    error  `json:"-"`
...
func NewUnauthorized(statusCode int, root error, msg, log, key string) *AppError {
	return &AppError{
...
func ErrInternal(err error) *AppError {
	return NewFullErrorResponse(http.StatusInternalServerError, err, "some thing wrong in the server", err.Error(), "ErrInternal")
}
...
func ErrNoPermission(err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("You have no poermission"),
